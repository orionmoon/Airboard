...
const loadAppGroups = async () => {
  try {
    ...
    console.log('App groups loaded in modal:', appGroups.value)
  } catch (error) {
    console.error('Error loading app groups in modal:', error)
    appGroups.value = []
  }
}
...
// Reset form when modal opens/closes and reload app groups
